	...
	<div class="container">
		...
		<div class="row justify-content-center my-4">
			...
			<div class="col-sm-4 col-md-3">
				...
				<hr>
				<div class="d-grid gap-3">
					<a href="pre_order.php" class="btn btn-outline-dark p-2 rounded-pill fs-5" type="button"><i class="bi bi-basket"></i> プレ発注</a>
				</div>
				...
				<div class="d-grid gap-2">
					...
					<div class="row justify-content-end">
						<div class="col-6 text-end">
							<a href="otc_search.php" class="btn btn-outline-dark p-2 rounded-pill fs-8" type="button"><i class="bi bi-search"></i> OTC検索</a>
						</div>
					</div>
